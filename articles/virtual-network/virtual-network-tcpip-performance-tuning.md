...
Neither ICMP nor TCP pings measure the accelerated networking datapath. To measure this, please read about Latte and SockPerf in this article.
...
Still, these packet types are indications that TCP throughput isn't achieving its maximum performance, for reasons discussed in other sections of [this article](/azure/virtual-network/virtual-network-test-latency).
